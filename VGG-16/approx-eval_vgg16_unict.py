...
def VGG_16(weights_path=None):
    ...
    model.add(FakeApproxConv2D(64, kernel_size=(3, 3), strides=1, activation='relu'))
    model.add(ZeroPadding2D((1,1)))
    model.add(FakeApproxConv2D(64, kernel_size=(3, 3), strides=1, activation='relu'))
    model.add(MaxPooling2D((2,2), strides=(2,2), data_format='channels_last'))

    model.add(ZeroPadding2D((1,1)))
    model.add(FakeApproxConv2D(128, kernel_size=(3, 3), activation='relu'))
    model.add(ZeroPadding2D((1,1)))
    model.add(FakeApproxConv2D(128, kernel_size=(3, 3), activation='relu'))
    model.add(MaxPooling2D((2,2), strides=(2,2), data_format='channels_last'))

    model.add(ZeroPadding2D((1,1)))
    model.add(FakeApproxConv2D(256, kernel_size=(3, 3), activation='relu'))
    model.add(ZeroPadding2D((1,1)))
    model.add(FakeApproxConv2D(256, kernel_size=(3, 3), activation='relu'))
    model.add(ZeroPadding2D((1,1)))
    model.add(FakeApproxConv2D(256, kernel_size=(3, 3), activation='relu'))
    ...
    model.add(ZeroPadding2D((1,1)))
    model.add(FakeApproxConv2D(512, kernel_size=(3, 3), activation='relu'))
    model.add(ZeroPadding2D((1,1)))
    model.add(FakeApproxConv2D(512, kernel_size=(3, 3), activation='relu'))
    model.add(ZeroPadding2D((1,1)))
    model.add(FakeApproxConv2D(512, kernel_size=(3, 3), activation='relu'))
...
#########################################
    ...
    results = model.evaluate(validation_generator, steps=5000, workers=10, max_queue_size=1)
